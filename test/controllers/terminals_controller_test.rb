...
class TerminalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create terminal" do
    assert_difference("Terminal.count") do
      post terminals_url, params: { terminal: { abbreviation: @terminal.abbreviation, name: @terminal.name, prepped_wire_id: @terminal.prepped_wire_id, quantity: @terminal.quantity } }
    end
  ...
  test "should update terminal" do
    patch terminal_url(@terminal), params: { terminal: { abbreviation: @terminal.abbreviation, name: @terminal.name, prepped_wire_id: @terminal.prepped_wire_id, quantity: @terminal.quantity } }
